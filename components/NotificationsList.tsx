...
export default function NotificationsList({ onClose }: { onClose: () => void }) {
  const { notifications, markAsRead, markAllAsRead, deleteSelected } = useNotifications();
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          {!multiSelectMode && displayedNotifications.some(n => !n.read) && (
            <TouchableOpacity style={styles.markAllButton} onPress={markAllAsRead}>
              <Text style={styles.markAllText}>Mark all read</Text>
            </TouchableOpacity>
          )}
          {displayedNotifications.length > 0 && !multiSelectMode && (
            <TouchableOpacity
          ...
          displayedNotifications.map((notification) => {
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                !notification.read && !multiSelectMode && styles.unreadNotification,
                multiSelectMode && isSelected && styles.selectedNotification
              ]}
...
const styles = StyleSheet.create({
  ...
  selectButton: { paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#e5e7eb', borderRadius: 8 },
  selectText: { fontSize: 14, color: '#374151', fontWeight: '600' },
  deleteSelectedButton: { paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#fee2e2', borderRadius: 8 },
  deleteSelectedText: { fontSize: 14, color: '#ef4444', fontWeight: '600' },
  cancelSelectButton: { paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#f3f4f6', borderRadius: 8 },
  cancelSelectText: { fontSize: 14, color: '#6366f1', fontWeight: '600' },
  ...
  selectedNotification: { backgroundColor: '#e0f2fe' },
