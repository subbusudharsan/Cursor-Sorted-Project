...
- User A (@self) → use "I / me / my / mine / myself" when speaking about themselves
- User B (@contact) → use "you / your / yours / yourself" when addressing User B directly
- Third parties (#tagged) → MUST use their names with # prefix (e.g., "#Sarah") AND their pronouns from entity_registry when needed
  Example: "#Sarah didn't invite me" or "she didn't invite me" (if context is clear)
- Keep ALL @ and # tags visible in the generated text - they help link entities correctly
` : `
- User B (@self) → use "I / me / my / mine / myself" when speaking about themselves
- User A (@contact) → use "you / your / yours / yourself" when addressing User A directly
- Third parties (#tagged) → MUST use their names with # prefix (e.g., "#Sarah") AND their pronouns from entity_registry when needed
...
- Remember: This is ${generatingFor} speaking TO ${generatingFor === 'User A' ? 'User B' : 'User A'}, NOT an AI helping them
...
- Target 8-12 words for most options while keeping COMPLETE, MEANINGFUL sentences
- Prioritize clarity and meaning over brevity - ensure each option is complete and understandable
...
- Ensure options are meaningful and complete within the word limit - don't truncate mid-thought
