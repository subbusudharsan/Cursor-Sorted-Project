...
STRICT RULES:
- Aim for 15 words or fewer (ideal 8–12 words).
- Each option must be a COMPLETE, MEANINGFUL sentence — never cropped mid-thought.
- If one or two extra words are needed to finish the idea naturally, that’s okay.
- Rewrite shorter rather than truncating; keep human tone and full sense.
- Use natural contractions ("I'm", "you're", "didn't").
- No filler words (“just”, “really”) unless they add emotion.
