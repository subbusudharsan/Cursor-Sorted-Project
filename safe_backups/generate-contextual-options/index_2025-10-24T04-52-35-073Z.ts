...
- "she really treated me badly at that party" (talking ABOUT third party TO contact)
- "they excluded me from the whole thing" (talking ABOUT group TO contact)
- "you did that without even asking me" (talking TO contact about their action)
...
FLEXIBLE PRONOUN USAGE BASED ON CONTEXT:
- Use "you" when User B addresses User A directly about User A's actions or when discussing how they interact
- Use "she/he/they/them" when User B talks TO User A ABOUT third parties or external situations
- Use "I/me/my" when sharing personal feelings and experiences
- The hint determines the subject and appropriate pronouns naturally
...
- "hey! miss talking to you - got a sec?"
- "hey stranger, can we chat about something?"
...
- "hey, wanted to bring something up"
- "hi, how are you? need to chat"
...
- "hi, how's it going? need to discuss something"
...
PRONOUN GUIDANCE FROM HINT:
- If hint discusses User A's actions toward User B, use "you" (e.g., "you did that without asking")
- If hint discusses third parties or external events, use "she/he/they" (e.g., "she treated me badly", "they excluded me")
- If hint is about User B's own feelings/experiences, use "I/me" (e.g., "I felt really hurt")

IMPORTANT: User B's options should feel like they're sharing their side thoughtfully, informed by what they're actually feeling. The hint context persists throughout the ENTIRE conversation.
` : ''}
...
${shouldUseHint ? `7. Subtly reflect their private feelings without exposing the hint directly
8. Maintain consistency with hint perspective across all turns` : ''}
...
STRICT RULES:
- 8-15 words max per option (emojis can be 1 character)
