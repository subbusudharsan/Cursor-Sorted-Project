...
if (!GROQ_API_KEY) {
  console.warn("⚠️ GROQ_API_KEY missing. AI insight generation will return a fallback insight.");
}
  ...
  const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: "system",
          content: "You generate one thoughtful weekly insight for a journaling companion app."
        },
