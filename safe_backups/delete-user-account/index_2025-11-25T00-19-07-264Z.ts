...
import { Client } from 'jsr:@supabase/postgrest-js@1';
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    try {
      ...
      // Note: Supabase's deleteUser should handle auth schema cleanup internally
      // If it fails, it's likely due to foreign key constraints from auth tables
      ...
      console.log("⚠️ Attempting deleteUser - Supabase should handle auth schema cleanup internally");
