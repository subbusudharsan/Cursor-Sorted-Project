...
// 🧹 Clean @tags from summary before returning
if (parsedResponse?.summary) {
  parsedResponse.summary = parsedResponse.summary.replace(/@\w+\b/g, 'you');
}
if (parsedResponse?.context_data?.summary) {
  parsedResponse.context_data.summary = parsedResponse.context_data.summary.replace(/@\w+\b/g, 'you');
}
